...
public class StringSpectrumDeviceTableViewer extends StringSpectrumTableViewer
{
	...
	protected Object[] getCells(String row)
	{
		...
		IDevStateScalar state = SardanaManager.getInstance().getSardanaDevice(devName).getStateAttributeModel();
	...
	public void clearTable()
	{
		...
		for(int i = 0; i < rowCount; i++)
		{
			...
			{
				((MyStateViewer)stateCell).getModel().removeDevStateScalarListener((MyStateViewer)stateCell);
			}
			model.removeRow(0);
		}
	}
