...
import es.cells.sardana.client.framework.PoolConfigLoader;
import es.cells.sardana.client.framework.PoolConfigLoader.AbstractItem;
...
public class SardanaConfigEditor extends JDialog
{
     ...
     * @throws XmlException 
     */
	public SardanaConfigEditor(PoolConfigLoader loader) throws XmlException, IOException
	{
		super();
		this.loader = loader;
		doc = loader.load();
