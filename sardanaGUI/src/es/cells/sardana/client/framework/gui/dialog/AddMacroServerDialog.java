...
public class AddMacroServerDialog extends JDialog 
{
	...
	private void initComponents() 
	{
		...
		ArrayList<String> pools = DevicePoolUtils.getInstance().getPoolDevices(this.machine);
...
//		
	...
	protected void createPressed() 
	{
		...
		try
		{
			DevicePoolUtils.getInstance().createMacroServer(info);
			
			JOptionPane.showMessageDialog(null, "MacroServer successfully created",
					"Success!",
