...
public class ControllerClass extends AbstractPoolClass
{
	...
	public ControllerClass(String ctrlData)
	{
		super(ctrlData);
	}

	protected void buildClassData(String classData)
	{
		Matcher m = DevicePoolUtils.CTRL_LIST_PATTERN.matcher(classData);
		
		if(m.matches() && m.groupCount() >= 4) 
		{
			setType(ControllerType.valueOf(m.group(1)));
			setClassName(m.group(2));
			setFullPathName(m.group(3));
