...
void FakeComController::AddDevice(long idx)
{
...
string &FakeComController::ReadLineOne(long idx)
{
	ostringstream oss;
...
long FakeComController::WriteOne(long, string &istr, long write_len /*= -1*/)
{	
	write_nb++;
...
string &FakeComController::WriteReadOne(long idx, string &istr, long write_len /*= -1*/, long max_read_len /*= -1*/)
{	
...
void FakeComController::StateOne(long idx,Controller::CtrlState *ch_info_ptr)
{
...
Controller::CtrlData FakeComController::GetExtraAttributePar(long idx,string &par_name)
{
...
void FakeComController::SetExtraAttributePar(long idx,string &par_name,Controller::CtrlData &new_value)
{
...
long FakeComController_MaxDevice = 12;
