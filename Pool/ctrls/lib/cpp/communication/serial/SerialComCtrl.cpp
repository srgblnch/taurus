...
ComController(inst)
{
	...
	{
		if(prop[loop].name == "TangoDevices")
		{
			int index = 1;
			vector<string> &str_vec = prop[loop].value.string_prop;
...
RemotePyTangoSerialController::~RemotePyTangoSerialController()
{
	...
	map<long,SerialLineData*>::iterator ite = sl_data.begin();
...
void RemotePyTangoSerialController::OpenOne(long idx)
{
	if(idx > max_device)
	{
...
void RemotePyTangoSerialController::CloseOne(long idx)
{
	if(idx > max_device)
	{
...
void RemotePyTangoSerialController::AddDevice(long idx)
{
...
void RemotePyTangoSerialController::DeleteDevice(long idx)
{
...
string &RemotePyTangoSerialController::ReadOne(long idx, long max_read_len /* = -1*/)
{
...
string &RemotePyTangoSerialController::ReadLineOne(long idx)
{
...
long RemotePyTangoSerialController::WriteOne(long idx, string &istr, long write_len /*= -1*/)
{	
...
string &RemotePyTangoSerialController::WriteReadOne(long idx, string &istr, long write_len /*= -1*/, long max_read_len /*= -1*/)
{	
...
void RemotePyTangoSerialController::StateOne(long idx,Controller::CtrlState *ch_info_ptr)
{
	if(sl_data[idx]->proxy == NULL)
	{
...
Controller::CtrlData RemotePyTangoSerialController::GetExtraAttributePar(long idx,string &par_name)
{
...
void RemotePyTangoSerialController::SetExtraAttributePar(long idx,string &par_name,Controller::CtrlData &new_value)
{
	string par_name_lower(par_name);
	transform(par_name_lower.begin(),par_name_lower.end(),par_name_lower.begin(),::tolower);
	...
	{
		Tango::DevShort value = (Tango::DevShort)new_value.lo_data;
...
long RemotePyTangoSerialController_MaxDevice = 64;
