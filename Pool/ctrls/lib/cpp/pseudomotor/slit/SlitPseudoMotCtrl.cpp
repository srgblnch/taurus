...
double Slit::CalcPhysical(long axis,vector<double> &pseudo_pos)
{
...
double Slit::CalcPseudo(long axis,vector<double> &physical_pos)
{
	if(axis == 1)
...
long Slit_MaxDevice = 2; // should be the pseudo motor role #
