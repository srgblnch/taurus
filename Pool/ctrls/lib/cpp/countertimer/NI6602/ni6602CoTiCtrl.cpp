...
void ni6602CoTiController::AddDevice(long idx)
{
...
void ni6602CoTiController::DeleteDevice(long idx)
{
  if(idx>0 && idx<=MAX_CHANNELS)
    channels[idx-1]=0;
}
...
void ni6602CoTiController::LoadOne(long idx, double new_value)
{
...
//
//-----------------------------------------------------------------------------
void ni6602CoTiController::StartOneCT(long idx)
{
  if(idx==master_idx)
    master_started=1;
}
...
void ni6602CoTiController::AbortOne(long idx)
{
  if (ctr_dev != NULL)
    {
...
double ni6602CoTiController::ReadOne(long idx)
{
  if (ctr_dev == NULL)
    {
      TangoSys_OMemStream o;
...
void ni6602CoTiController::StateOne(long idx,Controller::CtrlState *info_ptr)
{
  if (ctr_dev != NULL)
    {
...
long ni6602CoTiController_MaxDevice = 8;
