...
void c208CoTiController::AddDevice(long idx)
{
...
void c208CoTiController::DeleteDevice(long idx)
{
  if(idx>0 && idx<=MAX_CHANNELS)
    channels&=(~(1<<(idx-1)));
}
...
void c208CoTiController::LoadOne(long idx, double new_value)
{
...
//
//-----------------------------------------------------------------------------
void c208CoTiController::StartOneCT(long idx)
{
  if(idx==master_idx)
    master_started=1;
}
...
void c208CoTiController::AbortOne(long idx)
{
  if (ctr_dev != NULL)
    {
...
double c208CoTiController::ReadOne(long idx)
{
  if (ctr_dev == NULL)
    {
      TangoSys_OMemStream o;
...
void c208CoTiController::StateOne(long idx,Controller::CtrlState *info_ptr)
{
  if (ctr_dev != NULL)
    {
...
long c208CoTiController_MaxDevice = 8;
