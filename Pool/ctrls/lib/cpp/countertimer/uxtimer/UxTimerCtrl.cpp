...
void UnixTimer::AddDevice(long idx)
{
...
void UnixTimer::DeleteDevice(long idx)
{
...
void UnixTimer::AbortOne(long idx)
{
...
//
	...
	{
		long delta_usec = ((now.tv_sec - last_read.tv_sec) * 1000000) + last_read.tv_usec - now.tv_usec;
...
double UnixTimer::ReadOne(long idx)
{
	...
	if (dev_ptr != NULL)
	{
		...
		if (th == start_th)
		{
			...
			if (dev_ptr->get_state() == Tango::MOVING)
			{
		    	...
		    	remain_ms = ti.it_value.tv_sec * 1000 + (long)(ti.it_value.tv_usec / 1000);
...
void UnixTimer::StateOne(long idx,Controller::CtrlState *ct_info_ptr)
{
...
void UnixTimer::LoadOne(long idx,double val)
{
...
//
//-----------------------------------------------------------------------------
void UnixTimer::StartOneCT(long idx)
{
