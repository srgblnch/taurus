...
void SimuZeroDController::AddDevice(long idx)
{
...
void SimuZeroDController::DeleteDevice(long idx)
{
...
double SimuZeroDController::ReadOne(long idx)
{
...
void SimuZeroDController::StateOne(long idx,Controller::CtrlState *mot_info_ptr)
{
...
Controller::CtrlData SimuZeroDController::GetExtraAttributePar(long idx,string &par_name)
{
...
void SimuZeroDController::SetExtraAttributePar(long idx,string &par_name,Controller::CtrlData &new_value)
{
	if (par_name == "CppZeroD_extra_1")
	{
		if (new_value.data_type == LONG)
			cout << "New value for CppZeroD_extra_1 extra attribute is " << new_value.lo_data << endl;
		else
...
long SimuZeroDController_MaxDevice = 2;
