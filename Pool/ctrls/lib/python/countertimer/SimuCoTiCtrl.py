...
class SimuCoTiController(CounterTimerController):
    ...
    def __init__(self,inst,props):
        ...
        print "PYTHON -> SimuCoTiController ctor for instance",inst

        self.ct_name = "SimuCoTiController/" + self.inst_name
        self.simu_ctrl = None
    ...
    def AddDevice(self,ind):
        print "PYTHON -> SimuCoTiController/",self.inst_name,": In AddDevice method for index",ind
...
#        raise RuntimeError,"Hola la la"
    ...
    def DeleteDevice(self,ind):
        print "PYTHON -> SimuCoTiController/",self.inst_name,": In DeleteDevice method for index",ind
    ...
    def PreReadAll(self):
        #print "PYTHON -> SimuCoTiController/",self.inst_name,": In PreReadAll method"
        pass
        

    def PreReadOne(self,ind):
        #print "PYTHON -> SimuCoTiController/",self.inst_name,": In PreReadOne method for index",ind
        pass

    def ReadAll(self):
        #print "PYTHON -> SimuCoTiController/",self.inst_name,": In ReadAll method"
        pass

    def ReadOne(self,ind):
        print "PYTHON -> SimuCoTiController/",self.inst_name,": In ReadOne method for index",ind
        if self.simu_ctrl != None:
    ...
    def AbortOne(self,ind):
        print "PYTHON -> SimuCoTiController/",self.inst_name,": In AbortOne method for index",ind
        if self.simu_ctrl != None:
    ...
    def PreStartAllCT(self):
        #print "PYTHON -> SimuCoTiController/",self.inst_name,": In PreStartAllCT method"
        self.wantedCT = []
	
    def StartOneCT(self,ind):
        #print "PYTHON -> SimuCoTiController/",self.inst_name,": In StartOneCT method for index",ind
        self.wantedCT.append(ind)
	
    def StartAllCT(self):
        #print "PYTHON -> SimuCoTiController/",self.inst_name,": In StartAllCT method"
        for index in self.wantedCT:
    ...
    def LoadOne(self,ind,value):
        #print "PYTHON -> SimuCoTiController/",self.inst_name,": In LoadOne method for index",ind," with value",value
        if self.simu_ctrl != None:
    ...
    def __del__(self):
        print "PYTHON -> SimuCoTiController/",self.inst_name,": Aarrrrrg, I am dying"
