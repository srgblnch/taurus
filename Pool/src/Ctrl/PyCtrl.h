...
/**
 * A utility class for ensuring the python interpreter lock in the
 * controller code. It's use has not been necessary so far (fortunately)
 * so maybe this class will be removed in the future
 */
class AutoPythonCtrlLock
{
protected:
