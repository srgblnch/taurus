...
Pool::PoolElement &Manager::get_elem_from_id(long )
{
...
Pool::ControllerPool &Manager::get_ctrl_from_id(long id)
{
...
Pool::ControllerPool &Manager::get_ctrl_from_elem_id(long id)
{
