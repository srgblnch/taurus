...
static const char *pool_doc = "The Sardana Device Pool interface.";
...
/** 
 * Method wrapper for PoolUtil.repr
 * 
 * @attention Not being used
 */
static PyObject *PoolUtil_repr(PyObject *obj)
{
	// TODO
	PoolUtil *self = (PoolUtil*)obj;
...
/** 
 * Method wrapper for PoolUtil.str
 * 
 * @attention Not being used
 */
static PyObject *PoolUtil_str(PyObject *obj)
{
	// TODO
	PoolUtil *self = (PoolUtil*)obj;
...
/** 
 * Method wrapper for print of PoolUtil
 * 
 * @attention Not being used
 */
static int PoolUtil_print(PyObject *obj, FILE *fp, int flags)
{
	PoolUtil *self = (PoolUtil*)obj;
...
{
	return PyInt_FromLong(self->get_version());
}
...
static const char *PoolUtil_doc = "The Sardana Device Pool Util interface111.";
...
cout << "[PyPoolUtil] WARNING: Creating device proxy without associating class" << endl;			
		}
	}
...
cout << "[PyPoolUtil] WARNING: Device proxy not created" << endl;
